...
// All params are good 
$possibleColumns = array("age","gender","race","politics","otherMinority",'empathy', 'racism', 'harmHateSpeech', 'lingPurism', 'freeSpeech', 'traditionalism', 'altruism');
$columnTypes = array("age"=> "i", "gender" => "s","race" => "s", "politics"=> "s",
  "otherMinority"=>"s","HITId" => "s","HITType" => "s","workerId" => "s","assignmentId" => "s",
  'empathy'=> "i", 'racism'=> "i", 'harmHateSpeech'=> "i", 'lingPurism'=> "i", 'freeSpeech'=> "i", 'traditionalism'=> "i", 'altruism' => "i"
  );
  
$insertColumns = array("age","gender","race","politics","otherMinority","HITId","HITType","assignmentId",'empathy', 'racism', 'harmHateSpeech', 'lingPurism', 'freeSpeech', 'traditionalism', 'altruism');
$conn = SQLconnect();
